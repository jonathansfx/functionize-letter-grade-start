...
function btnClicked() {
  ...
  document.getElementById("eng-letter").innerHTML = determineGrade(engPercent);
  document.getElementById("soc-letter").innerHTML = determineGrade(socPercent);
  document.getElementById("math-letter").innerHTML =
    determineGrade(mathPercent);
  document.getElementById("sci-letter").innerHTML = determineGrade(sciPercent);
}
